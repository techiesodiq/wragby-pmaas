  ...
  const pricingPlans = [
    {
      ...
      features: [
        ...
        "Optional PMO Lite Setup: From ₦15,000,000",
      ],
      addOns: ["PMP Training: From ₦300,000", "Custom Reports: From ₦400,000"],
      buttonText: "Subscribe",
    },
    {
      title: "Standard",
      price: "From ₦6,400,000/month",
      features: [
        ...
        "Optional PMO Setup: From ₦20,000,000",
      ],
      addOns: [
        "Extra PM: From ₦1,000,000/month",
        "Tool Config: From ₦2,000,000",
        "PMP/Agile Training: From ₦300,000",
      ],
      buttonText: "Subscribe",
    },
    {
      title: "Premium",
      price: "From ₦12,800,000/month",
      features: [
        ...
        "MS Project, Azure DevOps integration",
        ...
        "Optional Premium PMO Setup: From ₦30,000,000",
      ],
      addOns: [
        "Extra Senior PM: From ₦2,000,000/month",
        "PMO Audit: From ₦5,000,000",
        "PM Tool Integration: From ₦3,000,000",
        "Executive Coaching: From ₦1,500,000/session",
      ],
      buttonText: "Subscribe",
    },
  ];
