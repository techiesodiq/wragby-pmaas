  ...
  const pricingPlans = [
    {
      ...
      features: [
        ...
        "Optional PMO Lite Setup: ₦15,000,000",
      ],
      addOns: ["PMP Training: ₦388,862", "Custom Reports: from ₦466,635"],
      buttonText: "Subscribe",
    },
    {
      title: "Standard",
      price: "₦6,400,000/month",
      features: [
        ...
        "Optional PMO Setup: ₦23,331,750",
      ],
      addOns: [
        "Extra PM: ₦6,221,800-₦13,065,780/month",
        "Tool Config: from ₦2,333,175",
        "PMP/Agile Training: ₦388,862-₦777,725",
      ],
      buttonText: "Subscribe",
    },
    {
      title: "Premium",
      price: "₦12,800,000/month",
      features: [
        ...
        "Optional Premium PMO Setup: ₦38,886,250",
      ],
      addOns: [
        "Extra Senior PM: ₦3,110,900/month",
        "PMO Audit: ₦9,332,700",
        "PM Tool Integration: from ₦4,666,350",
        "Executive Coaching: ₦1,555,450/session",
      ],
      buttonText: "Subscribe",
    },
  ];
